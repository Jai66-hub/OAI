...
class Auth_response_param : public InformationElement
{
...
public:
    ...
    typedef struct{
        uint8_t    m_u8length; 
        uint8_t    m_u8Response[16]; 
    }m_sLen_Value;


    explicit Auth_response_param() = default; 
    explicit Auth_response_param(m_sLen_Value m_lvalue);
