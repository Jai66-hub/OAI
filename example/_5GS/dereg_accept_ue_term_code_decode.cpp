...
class Dereg_accpt_ue_term_test : public ::testing::Test{
...
public:
       ...
       int retsize(IE::Auth_response_param in_Authparam)
       {
        ...
        Deregistration_acpt_UE_term ARacp(
...
TEST_F(Dereg_accpt_ue_term_test, testdecodesht_valid)
{
...
TEST_F(Dereg_accpt_ue_term_test, testdecodesho_crct)
{     
    // for decode
...
TEST_F(Dereg_accpt_ue_term_test, testdecodesho_wrong)
{
  //for decode   
